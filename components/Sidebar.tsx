...
const renderSelect = (
  ...
  <div className="mb-4">
    ...
    <select
      value={value}
      onChange={onChange}
      className="w-full p-2 bg-[#324446] border border-[#41403f] rounded-md focus:outline-none focus:ring-2 focus:ring-[#736b23]"
    >
  ...
  return (
    <aside className="w-80 bg-[#191f29] border-l border-[#41403f] p-4 flex flex-col">
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={onDeselect} className="p-1 rounded-full hover:bg-[#435360]" aria-label="Deselect Hex">
      ...
      <div className="flex-grow overflow-y-auto">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-[#a7a984] mb-2">

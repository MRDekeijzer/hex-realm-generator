    ...
    <aside className="w-80 bg-[#191f29] border-l border-[#41403f] p-4 flex flex-col">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onClose}
            className="p-1 rounded-full hover:bg-[#435360]"
      ...
      <div className="flex-grow overflow-y-auto pr-2">
        ...
        <p className="text-sm text-[#a7a984] mb-4">
        ...
        <div className="space-y-2">
          {tileSets.terrain.map((terrain) => {
            ...
            const defaultColor =
              DEFAULT_TERRAIN_COLORS[terrain.id as keyof typeof DEFAULT_TERRAIN_COLORS];
            ...
            return (
              <div
                ...
                ${
                  isSelected
                    ? 'bg-[#736b23]/20 border-[#736b23]'
                    : 'bg-[#18272e] border-[#41403f] hover:border-[#a7a984]'
                }`}
                title={`Paint ${terrain.label}`}
              >
                <span
                  className={`font-medium text-sm truncate flex-grow ${
                    isSelected ? 'text-[#eaebec]' : 'text-[#a7a984]'
                  }`}
                >
                  {terrain.label}
                </span>
        ...
        <div className="mt-6 pt-4 border-t border-[#41403f]">
          ...
          <form onSubmit={handleAddSubmit}>
            <div className="mb-2">
              <label htmlFor="terrain-name" className="block text-sm font-medium text-[#a7a984] mb-1">
                Name
              </label>
              <input
                id="terrain-name"
            ...
            <div className="mb-4">
              <label htmlFor="terrain-color" className="block text-sm font-medium text-[#a7a984] mb-1">
                Color
              </label>
              <div className="flex items-center gap-2">
                <input

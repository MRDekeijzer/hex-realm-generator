  ...
  return (
    <aside className="w-80 bg-[#191f29] border-l border-[#41403f] p-4 flex flex-col">
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={onClose} className="p-1 rounded-full hover:bg-[#435360]" aria-label="Close Myth Tool">
      ...
      <div className="flex-grow overflow-y-auto pr-2 space-y-4">
        <div>
          ...
          {realm.myths.length > 0 ? (
              ...
              {realm.myths
                ...
                .map((myth) => {
                  ...
                  return (
                    <li
                      key={myth.id}
                      className="bg-[#18272e] rounded-md overflow-hidden transition-all duration-300"
                    >
                      <button
                      ...
                      >
                        <div>
                          <p className="font-semibold text-[#736b23]">
                            Myth #{myth.id}: <span className="text-[#eaebec]">{myth.name}</span>
                          </p>
                        ...
                        <Icon
                          ...
                          className="w-5 h-5 text-[#a7a984] flex-shrink-0"
                        />
                      </button>
                        ...
                        <div className="p-3 border-t border-[#41403f]/50 bg-[#18272e]/50 space-y-3">
                          <div>
                            <label
                              ...
                              className="block text-sm font-medium text-[#a7a984] mb-1"
                            >
                              Edit Name
                            </label>
                            <input
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className={`w-full flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium rounded-md transition-colors ${
                                isRelocating
                                  ? 'bg-[#435360]/80 text-[#eaebec] hover:bg-[#435360]'
                      ...
                      {isRelocating && (
                        <div className="p-3 bg-[#435360]/50 text-center text-sm text-[#c5d2cb]">
            ...
            <p className="text-[#a7a984] text-center py-4">

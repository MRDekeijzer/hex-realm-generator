          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setGenerationOptions((prev) => ({
                  ...prev,
                  numHoldings: Math.max(0, parseInt(e.target.value, 10) || 0),
                }))
              }
              min="0"
              className="w-full bg-[var(--color-surface-primary)] p-2 text-sm font-medium text-[var(--color-text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-primary)] rounded-md"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setGenerationOptions((prev) => ({
                  ...prev,
                  numMyths: Math.max(0, parseInt(e.target.value, 10) || 0),
                }))
              }
              min="0"
              className="w-full bg-[var(--color-surface-primary)] p-2 text-sm font-medium text-[var(--color-text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-primary)] rounded-md"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setGenerationOptions((prev) => ({
                ...prev,
                mythMinDistance: Math.max(0, parseInt(e.target.value, 10) || 0),
              }))
            }
            min="0"
            className="w-full bg-[var(--color-surface-primary)] p-2 text-sm font-medium text-[var(--color-text-secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-primary)] rounded-md"

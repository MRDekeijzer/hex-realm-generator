          ...
          <div className="flex-1 overflow-y-scroll px-8 pb-8">
            ...
            {activeTab === 'color' && (
              <ColorSettings
                ...
                mythMarkerFillColor={props.colorSettings.mythMarkerFillColor}
                mythMarkerBorderColor={props.colorSettings.mythMarkerBorderColor}
                mythMarkerBorderWidth={props.colorSettings.mythMarkerBorderWidth}
                onUpdateMythMarkerFillColor={props.colorSettings.onUpdateMythMarkerFillColor}
                onResetMythMarkerFillColor={props.colorSettings.onResetMythMarkerFillColor}
                onUpdateMythMarkerBorderColor={props.colorSettings.onUpdateMythMarkerBorderColor}

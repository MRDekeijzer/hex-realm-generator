...
export const iconPaths: { [key: string]: string[] } = {
  ...
  sprout: ['M7 20h10', 'M10 20v-3a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v3', 'M12 15s2-2 2-3c0-1.1-1-2-2-2-1 0-2 .9-2 2 0 1 2 3 2 3Z', 'M12 3v1'],
  shrub: ['M12 22v-6', 'M12 8V2', 'M6 12H2', 'M22 12h-4', 'M15 5.09a7 7 0 0 1 0 13.82', 'M9 18.91A7 7 0 0 1 9 5.08'],
  triangle: [
    'M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 3.73 21h16a2 2 0 0 0 1.73-3Z',
  ],
  ...
  sun: ['M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0-8 0', 'M12 2v2', 'M12 20v2', 'M5 5l1.5 1.5', 'M17.5 17.5L19 19', 'M2 12h2', 'M20 12h2', 'M5 19l1.5-1.5', 'M17.5 6.5L19 5'],
  wind: ['M17.7 7.7a2.5 2.5 0 1 0-3.54 0L12 10l-2.12-2.12a2.5 2.5 0 1 0-3.54 0L6 8.17', 'M12 12l-2.12 2.12a2.5 2.5 0 1 0 3.54 0L14.12 12', 'M18.17 12l-2.12-2.12a2.5 2.5 0 1 0-3.54 0L12 10', 'M7 12l2.12 2.12a2.5 2.5 0 1 0 3.54 0L12 12.01'],
  star: ['M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.77 5.82 22 7 14.14 2 9.27l6.91-1.01L12 2z'],
  sparkle: ['M9.9 2.1c.2-.4.7-.4 1 0l1.2 2.5c.1.2.4.3.6.3h2.7c.5 0 .7.5.3.8l-2.2 1.6c-.2.1-.3.4-.2.6l1 2.7c.1.5-.3.9-.8.6l-2.3-1.7c-.2-.1-.5-.1-.7 0l-2.3 1.7c-.5.3-1-.1-.8-.6l1-2.7c.1-.2 0-.5-.2-.6L3.3 5.7c-.4-.3-.2-.8.3-.8H6c.3 0 .5-.1.6-.3l1.2-2.5z'],
  cloud: ['M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z'],
  rock: ['M12 22l-4-4', 'm-4 0l-4-4', 'M4 14l4-4', 'm4 0l4-4', 'M12 6l4 4', 'm4 0l4 4', 'M20 18l-4-4', 'm-4 4l-4 4'],
  flag: ['M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z', 'M4 22v-7'],
  snowflake: ['M10 2l-2.5 4.5', 'M14 2l2.5 4.5', 'M12 2V8', 'm-4.5 2.5L2 10', 'm15.5 2.5L22 10', 'M16 8H8', 'M2 14l5.5 2.5', 'M22 14l-5.5 2.5', 'M8 16h8', 'M10 22l2.5-4.5', 'M14 22l-2.5-4.5', 'M12 16v6'],
  branch: ['M5 22h14', 'M12 22V6', 'M12 6H8.5a2.5 2.5 0 0 1 0-5H12', 'M12 6h3.5a2.5 2.5 0 1 0 0-5H12'],
  river: ['M3 17l6-6 4 4 6-6'],
  path: ['M3 17l4-4 4 4 4-4', 'M3 7l4 4 4-4 4 4'],
  'wave-sine': ['M2 12h3l3 3 3-6 3 3h2'],
  'chevron-up': ['M18 15l-6-6-6 6'],
  skull: ['M20 20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2Z', 'M8 12h8', 'M9 16h6', 'M9 8h.01', 'M15 8h.01'],
  fish: ['M6.5 13.5v-11', 'M10 12v-1.5', 'm10 3v1.5', 'M15.5 13.5v-11', 'M18 12v-1.5', 'm0 3v1.5', 'M2 13.5h20', 'M2 5.5h20', 'M13.5 12h-3', 'm0 3h3', 'M11 2v20', 'M15.5 5.5v-4', 'M6.5 5.5v-4', 'M6.5 13.5v8', 'M15.5 13.5v8', 'M4 12v1.5', 'M4 9v1.5'],
  'tree-deciduous': ['M12 22v-6', 'M6 16H4.2c-1.2 0-2.2-1-2.2-2.2V12c0-1.2 1-2.2 2.2-2.2H6', 'M18 16h1.8c1.2 0 2.2-1 2.2-2.2V12c0-1.2-1-2.2-2.2-2.2H18', 'M12 16a6 6 0 0 0 6-6h-2a4 4 0 0 1-4 4V4a2 2 0 1 0-4 0v6a4 4 0 0 1-4-4H6a6 6 0 0 0 6 6z'],
  sparkles: ['M9.5 2.1c.2-.4.7-.4 1 0l1.2 2.5c.1.2.4.3.6.3h2.7c.5 0 .7.5.3.8l-2.2 1.6c-.2.1-.3.4-.2.6l1 2.7c.1.5-.3.9-.8.6l-2.3-1.7c-.2-.1-.5-.1-.7 0l-2.3 1.7c-.5.3-1-.1-.8-.6l1-2.7c.1-.2 0-.5-.2-.6L3 5.7c-.4-.3-.2-.8.3-.8H6c.3 0 .5-.1.6-.3l1.2-2.5z', 'M15 15.3c.2-.4.7-.4 1 0l.6 1.2c.1.2.4.3.6.3h1.4c.5 0 .7.5.3.8l-1.1 1c-.2.1-.3.4-.2.6l.5 1.4c.1.5-.3.9-.8.6l-1.2-.9c-.2-.1-.5-.1-.7 0l-1.2.9c-.5.3-1-.1-.8-.6l.5-1.4c.1-.2 0-.5-.2-.6l-1.1-1c-.4-.3-.2-.8.3-.8H15c.3 0 .5-.1.6-.3l.6-1.2z'],
};
